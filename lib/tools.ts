...
export const TOOLS: FolioTool[] = [
  ...
  },
  {
    ...
    name: "Sign PDF",
    shortName: "Sign",
    description: "Add your signature visually to a PDF, entirely in your browser.",
    longDescription:
      "Open a PDF, create or upload a signature, place it on one or more pages, and download a new signed PDF. This is a visual signature workflow, not a certificate-based digital signature.",
    accepts: ".pdf",
    acceptMime: ["application/pdf"],
    multiple: false,
    maxFiles: 1,
