    ...
    <div className="mx-auto max-w-3xl px-5 py-12">
      ...
      <div className="prose-folio mt-8 space-y-6 text-[16px] leading-relaxed text-ink-700">
        ...
        <section className="rounded-2xl border border-slate-200 p-5">
          ...
          <p className="mt-2">
            Pages, Numbers and high-fidelity Office conversions are{" "}
            <strong>
            ...
            kept for localhost development only), which drives the supported desktop app you already have (Pages,
          ...
          <p className="mt-2 text-[15px] text-ink-500">
            Keynote → PDF and Keynote → PPTX remain Beta / unvalidated because
            macOS Automation permission does not remain enabled reliably in the
            current release. They are deferred known limitations, not guaranteed
            conversions.
          </p>
